...
export function ToolButton({
  ...
  return (
    <button
      className={`w-10 h-10 flex items-center justify-center rounded transition-all border text-on-surface-variant hover:text-on-surface hover:bg-surface-bright/50 disabled:opacity-30 disabled:cursor-not-allowed ${
        active
